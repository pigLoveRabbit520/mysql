...
class Connection
{
     ...
     * @param string $col_name 字段名
     * @param string $where 条件
     * @param int $number 数量
     * @return mixed
     */
    public function updateAdd($table, $col_name, $where, $number=1)
    {
        return $this->query("UPDATE $table SET `$col_name` = `$col_name` + $number where  $where");
    }
     ...
     * @return mixed
     */
    public function updateSub($table, $col_name, $where, $number=1)
    {
        return $this->query("UPDATE $table SET `$col_name` = `$col_name` - $number where $where");
    }
    /**
